      ...
      <div class="grid">
        <div style="display: flex; justify-content: center; margin-top: 10px">
          <img
            ...
            src="../assets/img/biti_uz.jpg"
            alt=""
          />
        </div>
        <p>BUXORO INNOVATSION TIBBIYOT INSTITUTI</p>
        <form
          @submit="Login"
          class="form login"
        >
          ...
          <div class="form__field">
            <label for="login__password"
              ...
              ><span class="hidden">Parol</span></label
            >
            <input
              id="login__password"
              v-model="password"
          ...
          <div class="form__field">
            ...
            <button class="submit">Kirish</button>
          </div>
        </form>
      </div>
...
:root {
  ...
  --loginSubmitBackgroundColor: #4cea79;
  --loginSubmitColor: #eee;
  --loginSubmitHoverBackgroundColor: #61d441;
}
